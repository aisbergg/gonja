...
func (stmt *IfEqualStmt) Position() *parse.Token { return stmt.Location }
...
func ifEqualParser(p *parse.Parser, args *parse.Parser) parse.Statement {
	ifequalNode := &IfEqualStmt{}

	// Parse two expressions
	ifequalNode.var1 = args.ParseExpression()
	ifequalNode.var2 = args.ParseExpression()
	...
	wrapper, endargs := p.WrapUntil("else", "endifequal")
	...
	if wrapper.EndTag == "else" {
		...
		wrapper, endargs = p.WrapUntil("endifequal")
