...
func (*NilValue) IsTrue() bool {
	return false
}
func (*NilValue) IsSafe() bool {
	errors.ThrowTemplateRuntimeError("cannot check if value is safe")
	return false
}
...
func (*NilValue) Integer() int {
	errors.ThrowTemplateRuntimeError("cannot convert nil value to integer")
	return 0
}
func (*NilValue) Float() float64 {
	errors.ThrowTemplateRuntimeError("cannot convert nil value to float")
	return 0
}
func (*NilValue) Bool() bool {
	errors.ThrowTemplateRuntimeError("cannot convert nil value to bool")
	return false
}
...
func (*NilValue) IterateOrder(fn func(idx, count int, key, value Value) bool, empty func(), reverse bool, sorted bool, caseSensitive bool) {
	errors.ThrowTemplateRuntimeError("cannot iterate over nil value")
}
